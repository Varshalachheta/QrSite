"""In version 5 , a error was generated when we use small input strings, the symbol size is not adjusting
 with the qr code ,so we changed the variables and added a function which uses string length to determine
  symbol size"""
import os
import img2pdf
