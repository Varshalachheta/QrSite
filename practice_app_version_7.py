"""In version 7 , i added a heading option in the index section which will
appear in the bottom of qr code after generation
...
def download():
    ...
    if file_type == 'png':
        ...
        #     pdf_canvas.drawString(50, 300, heading)
